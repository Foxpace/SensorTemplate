...
class ActivityDetectionManager(detectionService: DetectionService) {

    private val TAG: String = "ActivityManager"

    private val activityRecognitionClient: ActivityRecognitionClient = ActivityRecognition.getClient(detectionService)
     ...
     */
    private val REQUEST_CODE_UPDATES = 457
    ...
    private val REQUEST_CODE_TRANSITION = 1654
